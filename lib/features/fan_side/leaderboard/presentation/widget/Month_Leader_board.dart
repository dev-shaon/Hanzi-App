...
class MonthLeaderBoard extends StatefulWidget {
  const MonthLeaderBoard({super.key});

  @override
  State<MonthLeaderBoard> createState() => _MonthLeaderBoardState();
}

class _MonthLeaderBoardState extends State<MonthLeaderBoard> {
  ...
  Widget build(BuildContext context) {
    ...
    double dynamicHeight = rest.isEmpty ? 250.h : 160.h + (rest.length * 77.h);
