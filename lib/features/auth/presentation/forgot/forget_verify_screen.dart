...
class ForgetVerifyScreen extends StatefulWidget {
  final String email;
  const ForgetVerifyScreen({super.key, required this.email});
...
class _ForgetVerifyScreenState extends State<ForgetVerifyScreen> {
  ...
  void _resendOtp() async {
    ...
    try {
      await postForgetEmailSendRxObj.post(email: widget.email);
  ...
  void _verifyOtp() async {
    ...
    try {
      bool success = await verifyForgetPassRxObj.verifyForgetPass(
        email: widget.email,
