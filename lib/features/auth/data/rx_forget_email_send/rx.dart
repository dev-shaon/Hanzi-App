...
final class PostForgetEmailSendRx extends RxResponseInt {
  final api = PostForgetEmailSendApi.instance;

  String message = kErrorGeneric;

  PostForgetEmailSendRx({required super.empty, required super.dataFetcher});
  ...
  Future<bool> post({String? email}) async {
    try {
      ...
      Map resdata = await api.postForgetEmailSend(data);
