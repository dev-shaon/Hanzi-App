...
class ShowAllByPriceScreen extends StatefulWidget {
  final String title;
  final int priceRange;

  const ShowAllByPriceScreen({
    super.key,
    required this.title,
  ...
  @override
  State<ShowAllByPriceScreen> createState() => _ShowAllByPriceScreenState();
}

class _ShowAllByPriceScreenState extends State<ShowAllByPriceScreen> {
  ...
  Future<void> _fetchData() async {
    ...
    try {
      ...
      do {
        await getCelebrityByPriceRxObj.fetchCelebrityByPrice(
          priceRange: widget.priceRange,
          page: currentPage,
        );
        final snapshot = getCelebrityByPriceRxObj.dataFetcher.value;
      ...
      log("Error fetching celebrities by price: $e");
    } finally {
