...
final class PostSendManagerOtpRx extends RxResponseInt {
  final api = PostSendManagerOtpApi.instance;

  String message = kErrorGeneric;

  PostSendManagerOtpRx({required super.empty, required super.dataFetcher});
  ...
  Future<bool> post({String? email}) async {
    try {
      ...
      Map resdata = await api.postSendManagerOtp(data);
      String otp = resdata['data']['otp'];
      appData.write(kkeyManagerOtp, otp);
